...
For a comprehensive analysis of KOR tokenomics, emission schedules, and the economic mechanisms that sustain the protocol, see the section on [Kontor Economics](/docs/economics/perpetual) and the [Economic Model](/docs/kontor/resources/economic-model) document.
