...
<Note>
**Full working code**: The complete source code for this example is available in [`example-contracts/shared-account-dynamic/`](https://github.com/KontorProtocol/Documentation/tree/main/example-contracts/shared-account-dynamic)
</Note>
...
and exports:
- `open`: Creates an account for the specified token and tenants
