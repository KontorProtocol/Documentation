...
For the complete technical specification including cryptographic primitives, protocol parameters, and formal security analysis, see the [Storage Protocol Specification](/docs/storage/resources/storage-protocol).