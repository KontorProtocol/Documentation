...
**Output:** `contract/target/wasm32-unknown-unknown/release/hello_world.wasm`

For optimized builds, you can use `wasm-opt` and `brotli` compression (optional for testing):
