...
![Kontor Embedded Consensus](/img/embedded-consensus-diagram.png)
...
![Kontor Node Architecture Overview](/img/node-architecture.svg)

![Kontor Indexer Architecture Detail](/img/indexer-architecture-detailed.svg)
